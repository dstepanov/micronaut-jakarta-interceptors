...
/**
 * Reads the {@code jakarta.enterprise.context.Dependent} scope of Jakarta Contexts and Dependency Injection as the
 * Micronaut scope of the same meaning, so that the beans of the technology compatibility kit are beans here.
 *
