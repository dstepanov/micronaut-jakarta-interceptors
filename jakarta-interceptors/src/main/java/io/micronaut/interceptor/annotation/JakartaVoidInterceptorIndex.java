...
/**
 * The type the interceptor classes whose interceptor methods all return nothing are found through.
 *
...
@FunctionalInterface
@Internal
public interface JakartaVoidInterceptorIndex {

    /**
     * Never invoked; the signature is the one of a lifecycle callback interceptor method, which returns nothing.
     *
     * @param context The context of an invocation
     * @throws Exception Whatever the interceptor method throws
     */
    void invoke(InvocationContext context) throws Exception;
}
