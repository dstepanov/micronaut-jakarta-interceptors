...
| Covered
| InterceptorValidationTest, including a conflict reached through binding annotations declared on each other in either order; InvalidStereotypeInterceptorBindingAnnotationsTest and InvalidTransitiveInterceptorBindingAnnotationsTest of the kit
|===
